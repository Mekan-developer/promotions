<div>
    ...
    <div data-lazy="true" class="main-container" x-data="{open:false}">
        ...
        <button type="button" x-on:click="open = !open" class="w-[154px] inline-flex items-center font-medium justify-center px-4 py-2 text-sm text-gray-900 dark:text-white rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
