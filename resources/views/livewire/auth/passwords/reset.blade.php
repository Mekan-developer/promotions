<div class="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center relative">
    <div class="w-full max-w-md" wire:loading.remove wire:target='resetPassword'>
        ...
        <div class="text-center mt-6 text-gray-600 dark:text-gray-400">
            Remembered your password? <a href="{{ route('login') }}" wire:navigate class="text-blue-600 dark:text-blue-300 hover:underline">Login</a>
        </div>
    </div>
    <x-loading targetName="resetPassword" />
</div>
