<div class="w-full overflow-x-auto shadow-md sm:rounded-sm p-2">
    <div class="relative bg-white dark:bg-gray-900 p-4 h-full">
        <div class="overflow-y-auto overflow-hidden h-full">
            <div class="mb-2">
                <h1 class="block mb-2 uppercase font-medium text-gray-900 dark:text-gray-200">{{ __('sidebar.suppliers') }}</h1>
            </div>
            <form wire:submit.prevent="save" autocomplete="off">
                <div class="grid gap-6 mb-6 md:grid-cols-1">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model.blur="email" autocomplete="off" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="mekan.developer@gmail.com" required />
