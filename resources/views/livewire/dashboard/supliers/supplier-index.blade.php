<div class="w-full overflow-x-auto p-2 rounded-sm">
    <div class="relative bg-white dark:bg-gray-900 p-6 h-full rounded-sm">
        <div  class="pb-4 flex justify-between">
            ...
            <a href="{{route('suppliers.create')}}" wire:navigate class="text-white shadow-md bg-gray-400 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-sm text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Add suplier</a>           
        </div>
