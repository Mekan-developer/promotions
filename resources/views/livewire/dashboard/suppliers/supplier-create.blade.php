<div class="w-full flex justify-center items-center shadow-md sm:rounded-sm p-2 h-full">
            ...
            <form wire:submit.prevent="save" autocomplete="off">
                <div class="grid gap-6 mb-6 md:grid-cols-1">
                    ...
                    <div>
                        ...
                        <textarea id="brands" wire:model.blur="brands" rows="4" autocomplete="off" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-md border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write about suppliers' brands here..."></textarea>
                    </div>
                </div>
                <div class="w-full flex justify-end items-center gap-8">
                    <a href="{{route('suppliers.index')}}" wire:navigate class="text-white">Cancel</a>
                    <button  class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create</button>
                </div>
            </form>
        </div>
    </div>
