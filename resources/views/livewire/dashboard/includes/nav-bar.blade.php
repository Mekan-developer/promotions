<nav class="fixed top-0 left-0 z-30 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a class="flex ms-2 md:me-24 dark:text-white">
                    <img class="h-[46px] filter-custom-gray dark:filter-custom-white"  
