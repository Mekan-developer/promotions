                ...
                @foreach ($promotions as $key => $promotion)
                    <tr class="{{ (($key+1)%2 != 1) ? 'bg-white dark:bg-gray-800 hover:bg-gray-50 ' : '' }} dark:hover:bg-gray-600 border-b dark:border-gray-700" >
                        ...
                        <td class="px-6 py-4 text-right inline-flex gap-6">
                            ...
                            <a wire:click="destroy({{$promotion->id}})" wire:confirm="Are you sure you want to delete this promotion?" class="font-medium  text-blue-600 dark:text-blue-500 hover:underline"><x-heroicon-o-trash class="size-6 hover:text-red-400"/></a>
                        </td>                        
                    </tr>
                 @endforeach
            </tbody>
