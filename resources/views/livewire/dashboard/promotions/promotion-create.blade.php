<div class="w-full flex justify-center items-center overflow-x-auto shadow-md sm:rounded-sm p-2">
    <x-error/> 
    <div class="relative bg-white dark:bg-gray-900 p-4 h-full w-full" wire:loading.remove wire:target='save, cancel'>
