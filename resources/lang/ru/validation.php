...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Поле :attribute было найдено в утечке данных. Пожалуйста, выберите другой :attribute.',
    ],
    ...
    'prohibited_unless' => 'Поле :attribute запрещено, если :other не равно одному из :values.',
